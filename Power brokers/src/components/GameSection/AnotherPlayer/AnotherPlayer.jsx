...
export default function AnotherPlayer({player, position}) {
    ...
    return (
        <div className="another-player" style={{backgroundColor: positionColors[position-1]}}>
            ...
            <PlayerIcon nickname={player == null ? null : player.name} isCurrentPlayer={false} isMainPlayer={player == null ? null : player.isMainPlayer} avatar={player == null ? null : player.avatar}/>
